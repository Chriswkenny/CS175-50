...
#Displays to User
print(f"Amount paid for stocks: ${amount_paid_for_stock}")
print(f"Commission paid of the purchase: ${purchase_commission}")
print(f"Anount the stock sold for: ${stock_sold_for}")
print(f"Commision paid on the sale: ${selling_comission}")
